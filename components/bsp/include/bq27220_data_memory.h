...
const bq27220_data_memory_entry_t dm_table[] = {
    ...
    {"Calibration", "Temperature", 0x91B8, BQ_DM_INTERNAL_MODEL_COEFFICIENT_1,
     "I2"},
    {"Calibration", "Temperature", 0x91BA, BQ_DM_INTERNAL_MODEL_COEFFICIENT_2,
     "I2"},
    {"Calibration", "Temperature", 0x91BC, BQ_DM_INTERNAL_MODEL_COEFFICIENT_3,
     "I2"},
    {"Calibration", "Temperature", 0x91BE, BQ_DM_INTERNAL_MODEL_COEFFICIENT_4,
     "I2"},
    {"Calibration", "Temperature", 0x91C0, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_1,
     "I2"},
    {"Calibration", "Temperature", 0x91C2, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_2,
     "I2"},
    {"Calibration", "Temperature", 0x91C4, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_3,
     "I2"},
    {"Calibration", "Temperature", 0x91C6, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_4,
     "I2"},
    {"Calibration", "Temperature", 0x91C8, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_5,
     "I2"},
    {"Calibration", "Temperature", 0x91CA, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_B_1,
     "I2"},
    {"Calibration", "Temperature", 0x91CC, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_B_2,
     "I2"},
    {"Calibration", "Temperature", 0x91CE, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_B_3,
     "I2"},
    {"Calibration", "Temperature", 0x91D0, BQ_DM_EXTERNAL_MODEL_COEFFICIENT_B_4,
     "I2"},
    {"Calibration", "Temperature", 0x91D2, BQ_DM_RC0, "I2"},
    {"Calibration", "Temperature", 0x91D4, BQ_DM_VOLTAGE_COMP_COEFFICIENT_1,
     "I2"},
    {"Calibration", "Temperature", 0x91D6, BQ_DM_VOLTAGE_COMP_COEFFICIENT_2,
     "I2"},
    {"Calibration", "Temperature", 0x91D8, BQ_DM_VOLTAGE_COMP_COEFFICIENT_3,
     "I2"},
    {"Calibration", "Temperature", 0x91DA, BQ_DM_VOLTAGE_COMP_INPUT_MULTIPLIER,
     "U1"},
    {"Calibration", "Temperature", 0x91DB, BQ_DM_VOLTAGE_COMP_OUTPUT_DIVISOR,
     "I2"},
    ...
    {"Configuration", "Charge Inhibit Cfg", 0x91F5, BQ_DM_CHG_INHIBIT_TEMP_LOW,
     "I2"},
    {"Configuration", "Charge Inhibit Cfg", 0x91F7, BQ_DM_CHG_INHIBIT_TEMP_HIGH,
     "I2"},
    ...
    {"Configuration", "Power", 0x921C, BQ_DM_OFFSET_CAL_INHIBIT_TEMP_HIGH,
     "I2"},
    {"Configuration", "Power", 0x921E, BQ_DM_SLEEP_VOLTAGE_TIME, "U1"},
    {"Configuration", "Power", 0x921F, BQ_DM_SLEEP_CURRENT_TIME, "U1"},
    {"Configuration", "Current Thresholds", 0x9228,
     BQ_DM_DISCHARGE_DETECTION_THRESHOLD, "I2"},
    {"Configuration", "Current Thresholds", 0x922A,
     BQ_DM_CHARGE_DETECTION_THRESHOLD, "I2"},
    {"Configuration", "Current Thresholds", 0x922C, BQ_DM_QUIT_CURRENT, "I2"},
    {"Configuration", "Current Thresholds", 0x922E, BQ_DM_DISCHARGE_RELAX_TIME,
     "U2"},
    {"Configuration", "Current Thresholds", 0x9230, BQ_DM_CHARGE_RELAX_TIME,
     "U1"},
    {"Configuration", "Current Thresholds", 0x9231, BQ_DM_QUIT_RELAX_TIME,
     "U1"},
    {"Configuration", "Data", 0x923C, BQ_DM_INITIAL_STANDBY, "I1"},
    {"Configuration", "Discharge", 0x9240, BQ_DM_SYSDOWN_SET_VOLT_THRESHOLD,
     "I2"},
    {"Configuration", "Discharge", 0x9242, BQ_DM_SYSDOWN_SET_VOLT_TIME, "U1"},
    {"Configuration", "Discharge", 0x9243, BQ_DM_SYSDOWN_CLEAR_VOLT_THRESHOLD,
     "I2"},
    ...
    {"Gas Gauging", "CEDV Configuration", 0x9251, BQ_DM_BATTERY_LOW_PERCENT,
     "U2"},
    {"Gas Gauging", "CEDV Configuration", 0x925B, BQ_DM_LEARNING_LOW_TEMP,
     "U1"},
    {"Gas Gauging", "CEDV Configuration", 0x9264, BQ_DM_OVERLOAD_CURRENT, "I2"},
    {"Gas Gauging", "CEDV Configuration", 0x9268, BQ_DM_SELF_DISCHARGE_RATE,
     "U1"},
    ...
    {"Gas Gauging", "CEDV Profile 1", 0x929B, BQ_DM_GAUGING_CONFIGURATION,
     "H2"},
    ...
    {"Gas Gauging", "CEDV Profile 1", 0x92A5, BQ_DM_CHARGE_TERMINATION_VOLTAGE,
     "I2"},
    ...
    {"Gas Gauging", "CEDV Smoothing Config", 0x9271, BQ_DM_SMOOTHING_CONFIG,
     "H1"},
    {"Gas Gauging", "CEDV Smoothing Config", 0x9272,
     BQ_DM_SMOOTHING_START_VOLTAGE, "I2"},
    {"Gas Gauging", "CEDV Smoothing Config", 0x9274,
     BQ_DM_SMOOTHING_DELTA_VOLTAGE, "I2"},
    {"Gas Gauging", "CEDV Smoothing Config", 0x9276,
     BQ_DM_MAX_SMOOTHING_CURRENT, "I2"},
    {"Gas Gauging", "CEDV Smoothing Config", 0x927B, BQ_DM_EOC_SMOOTH_CURRENT,
     "U1"},
    {"Gas Gauging", "CEDV Smoothing Config", 0x927C,
     BQ_DM_EOC_SMOOTH_CURRENT_TIME, "U1"},
};
